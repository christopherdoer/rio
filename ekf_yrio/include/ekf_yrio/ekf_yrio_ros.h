...
{
/**
 * @brief The EkfYRioRos class is the ros interface of the EkfYRio class providing an online processing (ros mode) and
...
public:
  ...
  /**
   * @brief EkfYRioRos constructor
   * @param nh   node handle
   */
  EkfYRioRos(ros::NodeHandle& nh);
...
private:
  ...
  EkfYRioFilter ekf_yrio_filter_;
